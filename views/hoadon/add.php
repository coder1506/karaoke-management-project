                  ...
                  <div class="col-md-12">
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group">
                          ...
                          <input type="text" id="mhd" name="addForm[maHoaDon]" value="" class="form-control username" placeholder="Nhập mã hóa đơn">
                        </div>
                      </div>
                    </div>
                    <div class="form-group  ">
                    ...
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></span>
                          <input type="number" min="1" id="sl" name="addForm[SoLuong]" class="form-control name">
                        </div>
                      </div>
                    </div>
                  </div>
