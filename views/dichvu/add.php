                    ...
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group">
                          ...
                          <input type="text" id="username" name="addForm[maDichVu]" value="" class="form-control username" placeholder="Nhập mã dịch vụ">
                        </div>
                      </div>
                    </div>
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></span>
                          <input type="text" id="name" name="addForm[tenDichVu]" value="" class="form-control name" placeholder="Nhập Tên">
                        </div>
                      </div>
                    </div>
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></span>
                          <textarea type="text" id="name" name="addForm[moTa]" class="form-control name"></textarea>
                        </div>
                      </div>
                    </div>
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></span>
                          <input type="number" min="0" id="name" name="addForm[donGia]" class="form-control name">
                        </div>
                      </div>
                    </div>
                    <div class="form-group  ">
                      ...
                      <div class="col-sm-8">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></span>
                          <input type="number" min="0" id="name" name="addForm[soLuong]" class="form-control name">
                        </div>
                      </div>
                    </div>
                    <div class="form-group  ">
